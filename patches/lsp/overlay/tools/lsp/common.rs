...
pub struct PreviewConfig {
    ...
    /// Preview UI language: "auto", "en", or "zh-cn"
    pub language: String,
    /// VS Code / client locale used when language is "auto"
...
pub enum PreviewToLspMessage {
    ...
    /// Copy text to the editor clipboard (handled by the VS Code extension)
    SetClipboard { text: String },
    /// Sync preview UI language back to the editor settings
    SetPreviewLanguage { language: String },
}

/// Custom LSP notification sent to the VS Code extension.
pub struct SetPreviewLanguageNotification;

impl lsp_types::notification::Notification for SetPreviewLanguageNotification {
    type Params = SetPreviewLanguageParams;
    const METHOD: &'static str = "slint/set_preview_language";
}

#[derive(Clone, Debug, serde::Deserialize, serde::Serialize)]
pub struct SetPreviewLanguageParams {
    pub language: String,
}

/// Custom LSP notification sent to the VS Code extension.
pub struct SetClipboardNotification;

impl lsp_types::notification::Notification for SetClipboardNotification {
    type Params = SetClipboardParams;
    const METHOD: &'static str = "slint/set_clipboard";
}
