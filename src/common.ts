...
export function languageClientOptions(
    ...
    return {
        ...
        initializationOptions: {
            clientLocale: vscode.env.language,
        },
        synchronize: {
            configurationSection: "slint",
        },
        middleware: {
...
export function activate(
    ...
    client.add_updater((cl) => {
        ...
        cl?.onNotification("slint/set_clipboard", (params: { text: string }) => {
            void vscode.env.clipboard.writeText(params.text);
        });
        cl?.onNotification(
            "slint/set_preview_language",
